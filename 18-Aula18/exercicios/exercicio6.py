...
# 2 - Como a entrada da festa é mais barata para mulheres (R$ 15,00) do que para os homens 
# (R$ 35,00) 
# deve-se separar os dois em duas listas separadas e salvar em arquivos separados. 
...
def entrada(lista_cadastro,codigo_cadastro):
    pass
